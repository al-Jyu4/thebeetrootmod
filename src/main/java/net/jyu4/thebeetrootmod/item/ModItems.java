...
public class ModItems {
    public static final DeferredRegister<Item> ITEMS =
            DeferredRegister.create(ForgeRegistries.ITEMS, TheBeetrootMod.MODID);
    ///------------------------------///
    public static final RegistryObject<Item> CANDY_BEETROOT = ITEMS.register("candy_beetroot",() -> new ItemBaseBeetroot(new Item.Properties().food(Foods.BEETROOT)));
    ...
    public static final RegistryObject<Item> PURPLE_BEETROOT = ITEMS.register("purple_beetroot",() -> new ItemBaseBeetroot(new Item.Properties().food(Foods.BEETROOT)));
    ...
    public static final RegistryObject<Item> YELLOW_BEETROOT = ITEMS.register("yellow_beetroot",() -> new ItemBaseBeetroot(new Item.Properties().food(Foods.BEETROOT)));
    ...
    public static final RegistryObject<Item> LEAF_BEET = ITEMS.register("leaf_beet",() -> new ItemBaseBeetroot(new Item.Properties()));
    ...
    public static final RegistryObject<Item> SUGAR_BEET = ITEMS.register("sugar_beet",() -> new ItemBaseBeetroot(new Item.Properties()));
    ...
    public static final RegistryObject<Item> ANCIENT_BEETROOT = ITEMS.register("ancient_beetroot",() -> new ItemBaseBeetroot(new Item.Properties()));
    ...
    public static final RegistryObject<Item> NETHER_BEETROOT = ITEMS.register("nether_beetroot",() -> new ItemBaseBeetroot(new Item.Properties().food(Foods.BEETROOT)));
    ...
    public static final RegistryObject<Item> CHORUS_BEETROOT = ITEMS.register("chorus_beetroot",() -> new ItemChorusBeetroot(new Item.Properties().food(ModFoods.CHORUS_BEETROOT)));
    public static final RegistryObject<Item> CHORUS_BEETROOT_SEEDS = ITEMS.register("chorus_beetroot_seeds",() -> new ItemNameBlockItem(ModBlocks.CHORUS_BEETROOT.get(), new Item.Properties()));

    public static final RegistryObject<Item> ECHO_BEETROOT = ITEMS.register("echo_beetroot",() -> new ItemEchoBeetroot(new Item.Properties().food(ModFoods.ECHO_BEETROOT)));
    ...
    public static final RegistryObject<Item> MISSING_BEETROOT = ITEMS.register("missing_beetroot",() -> new ItemBaseBeetroot(new Item.Properties().food(Foods.BEETROOT)));
    ...
    public static final RegistryObject<Item> AMETHYST_BEETROOT = ITEMS.register("amethyst_beetroot",() -> new ItemBaseBeetroot(new Item.Properties().food(Foods.BEETROOT)));
    ...
    public static final RegistryObject<Item> TOPAZ_BEETROOT = ITEMS.register("topaz_beetroot",() -> new ItemBaseBeetroot(new Item.Properties().food(Foods.BEETROOT)));
    ...
    public static final RegistryObject<Item> SAPPHIRE_BEETROOT = ITEMS.register("sapphire_beetroot",() -> new ItemBaseBeetroot(new Item.Properties().food(Foods.BEETROOT)));
    ...
    public static final RegistryObject<Item> RUBY_BEETROOT = ITEMS.register("ruby_beetroot",() -> new ItemBaseBeetroot(new Item.Properties().food(Foods.BEETROOT)));
    ...
    public static final RegistryObject<Item> SANGUINE_BEETROOT = ITEMS.register("sanguine_beetroot",() -> new ItemBaseBeetroot(new Item.Properties().food(Foods.BEETROOT)));
    ...
    public static final RegistryObject<Item> STARDUST_BEETROOT = ITEMS.register("stardust_beetroot",() -> new ItemBaseBeetroot(new Item.Properties().food(Foods.BEETROOT)));
    ...
    public static final RegistryObject<Item> ARCANE_BEETROOT = ITEMS.register("arcane_beetroot",() -> new ItemBaseBeetroot(new Item.Properties().food(Foods.BEETROOT)));
