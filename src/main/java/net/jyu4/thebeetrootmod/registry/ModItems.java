...
public class ModItems {
    ...
    ///------------------------------///
    public static final RegistryObject<Item> CANDY_BEETROOT = ITEMS.register("candy_beetroot",() -> new Item(new Item.Properties().food(Foods.BEETROOT)));
    ...
    public static final RegistryObject<Item> PURPLE_BEETROOT = ITEMS.register("purple_beetroot",() -> new Item(new Item.Properties().food(Foods.BEETROOT)));
    ...
    public static final RegistryObject<Item> YELLOW_BEETROOT = ITEMS.register("yellow_beetroot",() -> new Item(new Item.Properties().food(Foods.BEETROOT)));
    ...
    public static final RegistryObject<Item> LEAF_BEET = ITEMS.register("leaf_beet",() -> new Item(new Item.Properties()));
    ...
    public static final RegistryObject<Item> ANCIENT_BEETROOT = ITEMS.register("ancient_beetroot",() -> new Item(new Item.Properties()));
    ...
    public static final RegistryObject<Item> NETHER_BEETROOT = ITEMS.register("nether_beetroot",() -> new Item(new Item.Properties().food(Foods.BEETROOT)));
    ...
    public static final RegistryObject<Item> AMETHYST_BEETROOT = ITEMS.register("amethyst_beetroot",() -> new Item(new Item.Properties().food(Foods.BEETROOT)));
    ...
    public static final RegistryObject<Item> TOPAZ_BEETROOT = ITEMS.register("topaz_beetroot",() -> new Item(new Item.Properties().food(Foods.BEETROOT)));
    ...
    public static final RegistryObject<Item> SAPPHIRE_BEETROOT = ITEMS.register("sapphire_beetroot",() -> new Item(new Item.Properties().food(Foods.BEETROOT)));
