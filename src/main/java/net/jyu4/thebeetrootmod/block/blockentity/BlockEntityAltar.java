...
public class BlockEntityAltar extends BlockEntity {
    ...
    public static void serverTick(Level pLevel, BlockPos pPos, BlockState pState, BlockEntityAltar pBlockEntity) {
        ++pBlockEntity.tickCount;
        long i = pLevel.getGameTime();
        List<BlockPos> list = pBlockEntity.effectBlocks;
        if (i % 40L == 0L) {
    ...
    private static void updateHunting(BlockEntityAltar pBlockEntity, List<BlockPos> pPositions) {
...
*/
    ...
    private static void updateDestroyTarget(Level pLevel, BlockPos pPos, BlockState pState, List<BlockPos> pPositions, BlockEntityAltar pBlockEntity) {
    ...
    private static void updateClientTarget(Level pLevel, BlockPos pPos, BlockEntityAltar pBlockEntity) {
